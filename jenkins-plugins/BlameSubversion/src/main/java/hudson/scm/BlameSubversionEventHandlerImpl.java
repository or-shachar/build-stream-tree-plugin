...
/**
 * {@link org.tmatesoft.svn.core.wc.ISVNEventHandler} that emulates the SVN CLI behavior.
 *  
 * Modify: changed by tang 
 *  
 * @author tang,Kohsuke Kawaguchi
 */
public class BlameSubversionEventHandlerImpl extends SVNEventAdapter {
    protected final PrintStream out;

    protected final File baseDir;

    public BlameSubversionEventHandlerImpl(PrintStream out, File baseDir) {
        this.out = out;
