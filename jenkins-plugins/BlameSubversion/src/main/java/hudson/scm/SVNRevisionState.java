...
/**
 * {@link hudson.scm.SCMRevisionState} for {@link hudson.scm.BlameSubversionSCM}. {@link java.io.Serializable} since we compute
 * this remote.
 * 
...
final class SVNRevisionState extends SCMRevisionState implements Serializable {
     ...
     * explicitly via {@link hudson.scm.BlameSubversionSCM#getLocations()} as well as those that
